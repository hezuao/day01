        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="deviceName" id="txt_search_deviceName"  class="form-control">
				</div>
			  </div>
			<div class="col-lg-2">
				<div class="input-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveSb.htm">
							...
							<tr>
								...
								<td>
									<select class="form-control" name="deviceType" id = "deviceType">
										...
										<option value="Ios_pad">Ios_pad</option>
                					</select>
                				</td>
							</tr>
							<tr>
